                                    ...
                                    <div>
                                        ...
                                        {dayImagePreviews[index] ? (
                                            ...
                                            <div
                                                onClick={
                                                    !isSubmitting
                                                        ? () => dayFileInputRefs.current[index]?.click()
                                                        : undefined
                                                }
                                                ...
                                                <div className="flex flex-col items-center">
                                                    <ImageIcon
                                                        className={`h-12 w-12 mb-4 ${
                                                            dayDragActive[index] ? 'text-purple-500' : 'text-gray-400'
                                                        }`}
                                                    />
                    ...
                    <div className="border-t-2 border-purple-200 dark:border-purple-800 pt-6">
                        ...
                        {hotelFields.map((field, index) => (
                            <div key={field.id} className="mb-6 p-6 border-2 border-purple-200 dark:border-purple-800 rounded-lg">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <label className={labelClassName}>Place Name <span className="text-red-500">*</span></label>
                                        <input
                                    ...
                                    <div>
                                        <label className={labelClassName}>Night Details <span className="text-red-500">*</span></label>
                                        <textarea
                                    ...
                                    <div>
                                        <label className={labelClassName}>Hotel Name <span className="text-red-500">*</span></label>
                                        <input
                                    ...
                                    <div>
                                        <label className={labelClassName}>Room Type <span className="text-red-500">*</span></label>
                                        <input
                                    ...
                                    <div>
                                        <label className={labelClassName}>Hotel Description <span className="text-red-500">*</span></label>
                                        <textarea

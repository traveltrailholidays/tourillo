...
type SortField = 'name' | 'email' | 'subject' | 'createdAt';
...
export const ContactList: React.FC<ContactListProps> = ({ contacts }) => {
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [search, contacts, statusFilter, sortField, sortDirection]);
    ...
    <div className="rounded bg-foreground shadow-lg border border-gray-200 dark:border-gray-700 p-4 md:p-6">
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-wrap gap-2 items-center justify-start">
            ...
            >
              All Messages <span className="ml-1 text-xs opacity-80">({stats.total})</span>
            </Button>
            <Button
              size="sm"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="px-4 py-3 bg-linear-to-r from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 rounded">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400 font-semibold">Total Messages</p>
            </div>
        ...
        {hasActiveFilters && (
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 flex-wrap">
            <span>
              Showing {filtered.length} of {stats.total} messages
            </span>
            {statusFilter !== 'ALL' && (
              <span
            ...
            {pageData.map((contact) => (
              <TableRow
                ...
                className={`hover:bg-gray-50 dark:hover:bg-gray-800/50 transition ${
                  !contact.isRead ? 'bg-purple-50/30 dark:bg-purple-900/10' : ''
                }`}
              >
                <TableCell>
                  {contact.isRead ? (
                ...
                <TableCell className="text-sm max-w-xs truncate">{contact.subject}</TableCell>
                  ...
                  <div className="flex gap-2 justify-end">
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="rounded">
                        <DialogHeader>
                          <DialogTitle>Delete this contact message?</DialogTitle>
                          <DialogDescription>
                            Are you sure you want to delete the message from <strong>{contact.name}</strong>? This
      ...
      {viewContact && (
        <Dialog open={!!viewContact} onOpenChange={() => setViewContact(null)}>
          <DialogContent className="max-w-[95vw] sm:max-w-2xl lg:max-w-4xl max-h-[90vh] overflow-y-auto rounded">
            <DialogHeader>
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-base font-medium wrap-break-word">{viewContact.name}</p>
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-base font-mono">{viewContact.phone}</p>
                </div>
                <div>
              ...
              <div>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded border border-gray-200 dark:border-gray-700">
                  <p className="text-sm sm:text-base whitespace-pre-wrap wrap-break-word">{viewContact.message}</p>
                </div>
              </div>
            </div>
            <DialogFooter className="gap-2">
              <Button
                variant="outline"
                onClick={() => handleToggleRead(viewContact)}
                className="cursor-pointer rounded"
              >
                {viewContact.isRead ? (
                  <>

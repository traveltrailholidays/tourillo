...
const RichTextEditor: React.FC<RichTextEditorProps> = ({ content, onChange, disabled = false }) => {
  ...
  if (!editor) {
    return <div className="h-[350px] bg-gray-100 dark:bg-gray-800 animate-pulse rounded" />;
  }
      ...
      <div className="bg-gray-50 dark:bg-gray-700 p-2 border-b border-gray-300 dark:border-gray-600 flex flex-wrap gap-1">
        ...
        <div className="flex gap-1 border-r border-gray-300 dark:border-gray-600 pr-2 relative">
          <div className="relative">
            ...
            {showColorPicker && (
              <div className="absolute top-full left-0 mt-1 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded shadow-lg p-2 z-50 grid grid-cols-7 gap-1">
          ...
          <div className="relative">
            ...
            {showHighlightPicker && (
              <div className="absolute top-full left-0 mt-1 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded shadow-lg p-2 z-50 flex gap-1">

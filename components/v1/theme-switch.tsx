...
const ThemeSwitch = () => {
  ...
  return (
    <button
      ...
      className="w-full flex items-center gap-3 p-3 bg-background text-theme-text rounded transition-all duration-200 hover:scale-[0.98] group cursor-pointer hover:bg-violet-100 dark:hover:bg-violet-900/20"
    >

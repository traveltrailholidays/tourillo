        ...
        <div className="flex flex-col gap-5">
          ...
          <motion.div variants={itemVariants}>
            <AccordionItem value="item-1" className="border-none">
              <AccordionTrigger className="hover:no-underline bg-foreground px-5 rounded cursor-pointer transition-all duration-75">
                Pay in Account
              </AccordionTrigger>
              <AccordionContent>
                  ...
                  <div className="p-12">
                    ...
                    <form className="text-[17px] mt-5 flex flex-col gap-2">
                      ...
                      <div className="w-full flex justify-end">
                        <button
                          type="submit"
                          className="bg-linear-to-r from-indigo-500 hover:from-indigo-500/90 via-purple-500 hover:via-purple-500/90 to-pink-500 hover:to-pink-500/90 px-3 py-[7px] rounded-xs cursor-pointer font-semibold text-white lg:flex items-center justify-center gap-2 mt-3"
                        >
                          Pay Now
                        </button>
                      </div>

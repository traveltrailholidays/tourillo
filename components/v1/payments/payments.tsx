    ...
    <main className="flex min-h-screen flex-col items-center justify-start min-w-screen overflow-x-hidden bg-background">
      ...
      <Container className={`px-3 md:px-5 w-[99%] mt-10 lg:mt-16`}>
        <div className={`flex justify-between flex-col md:flex-row gap-10`}>
          ...
          <div className={`rounded bg-foreground p-10 max-w-[450px] w-full h-auto md:h-[310px]`}>
            <div>
        ...
        <div className={`text-violet-600 dark:text-violet-400 w-full flex justify-center py-20 px-2 text-center`}>
          <div>

  ...
  return (
    <Section className="py-8 sm:py-12 md:py-16 lg:py-20">
      <Container className="w-full">
        <div className="flex w-full justify-between items-start sm:items-center flex-col sm:flex-row gap-4 sm:gap-0">
          <SectionHeading 
            mainHeading="Select Theme" 
            subHeading="Browse Packages Through THEMES" 
          />
          <div className="flex items-center justify-center gap-2 sm:gap-4 self-end sm:self-auto">
            <button

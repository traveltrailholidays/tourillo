...
const Hero = () => {
  return (
    <div className="flex flex-col md:flex-row-reverse relative bg-foreground">
      {/* Image */}
      <Image
        width={1000}
        height={1000}
        ...
        alt="heroSection"
        className="w-full md:w-[65%] 2xl:w-1/2 h-[400px] sm:h-[450px] md:h-[450px] lg:h-[600px] object-cover select-none"
        quality={100}
      />
      ...
      <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 md:top-1/2 md:-translate-y-[40%] md:right-1/2 md:left-auto md:translate-x-7 xl:-translate-x-5 2xl:-translate-x-10 flex flex-col gap-5 lg:gap-10 px-4 md:px-0 md:items-start">
        ...
        >
          <Link
            href="/packages"
            className="bg-linear-to-r from-indigo-500 hover:from-indigo-500/90 via-purple-500 hover:via-purple-500/90 to-pink-500 hover:to-pink-500/90 w-fit px-3 py-2 rounded text-white font-semibold flex gap-5 items-center group"
          >
            Explore Now
